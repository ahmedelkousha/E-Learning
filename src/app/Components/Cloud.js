...
const FeatureCard = ({ title, description, icon, backgroundColor }) => {
  return (
    <div className="relative flex flex-col items-center justify-center bg-white p-6 rounded-lg shadow-lg text-center">
      <div
        className={`mb-7 transform p-3 rounded-full text-white translate-y-[-20px] ${backgroundColor}`}
      >
        {icon}
      </div>
